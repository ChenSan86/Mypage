...
const initializeKeyPool = async () => {
  try {
    ...
    if (!exists) {
      ...
      await redis.hmset(
        "key_pool",
        "sk-DRo2524SJhYokrQnCZmqeUNgC8FTAZynuyaDQFlXuOcDgmg4",
        JSON.stringify({ max: 100, used: 0 }),
        "sk-zCMiiWdvfsQg5zneer1W4uGT8XEXrVXo7aptN438fIAtfXWV",
        JSON.stringify({ max: 100, used: 0 }),
        "sk-cGZ3qcjwsXXpI7adfXbeOQlyzGmHi7O1SYpMcCrEQpCoi9G1",
        JSON.stringify({ max: 100, used: 0 })
      );
